package com.example.michelle.whathis;
...
public class CameraActivity extends AppCompatActivity {
    ...
    private TextureView.SurfaceTextureListener mSurfaceTextureListener = new TextureView.SurfaceTextureListener() {
        ...
        public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int width, int height) {
            Toast.makeText(CameraActivity.this, "TextureView size has changed", Toast.LENGTH_SHORT).show();
        }
...
//            Toast.makeText(CameraActivity.this, "TextureView updated", Toast.LENGTH_SHORT).show();
        }
    };
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailebleListener = new
            ...
            switch (mCaptureState) {
                ...
                case STATE_WAIT_LOCK:
                    ...
                    if (afState == CaptureResult.CONTROL_AF_STATE_FOCUSED_LOCKED ||
                        ...
                        Toast.makeText(CameraActivity.this, "LOCKED AF!", Toast.LENGTH_SHORT).show();
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        // Perfom layout actions when has focus
        if (hasFocus) {
    ...
    private void setupCamera(int width, int height) {
        ...
        try {
            for (String cameraId : cameraManager.getCameraIdList()) {
                ...
                mImageReader.setOnImageAvailableListener(mOnImageAvailebleListener, mBackgroundHandler);
                mCameraId = cameraId;
                return;
            }
